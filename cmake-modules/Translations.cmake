...
macro (add_translations_directory NLS_PACKAGE)
    ...
    endforeach (LANGUAGE_NEEDED ${LANGUAGES_NEEDED}) # generate .mo from .po
...
macro (configure_file_translation SOURCE RESULT PO_DIR)
    if (NOT TARGET i18n-data)
        add_custom_target (i18n-data ALL COMMENT "Build translated data files")
    endif ()
...
macro (add_translations_catalog NLS_PACKAGE)
    ...
    if (NOT "${C_SOURCE}" STREQUAL "")
        add_custom_command (TARGET pot
                            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
                            COMMAND ${BASE_XGETTEXT_COMMAND} ${C_SOURCE})
        set (CONTINUE_FLAG "-j")
    endif ()

    if (NOT "${CPP_SOURCE}" STREQUAL "")
        add_custom_command (TARGET pot
                            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
                            COMMAND ${BASE_XGETTEXT_COMMAND} ${CPP_SOURCE})
        set (CONTINUE_FLAG "-j")
    endif ()
    ...
    add_custom_target (po COMMENT "Sync translation files (.po files)")
