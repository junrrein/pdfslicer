...
file (GLOB RSVG_DLL "${FEDORA_MINGW_LIBBINPATH}/librsvg*.dll")
file (GLOB CROCO_DLL "${FEDORA_MINGW_LIBBINPATH}/libcroco*.dll")
file (GLOB XML2_DLL "${FEDORA_MINGW_LIBBINPATH}/libxml2*.dll")
file (GLOB HARFBUZZ_DLL "${FEDORA_MINGW_LIBBINPATH}/libharfbuzz*.dll")
...
set (GTK_SHARE_DIR "/usr/x86_64-w64-mingw32/sys-root/mingw/share")
install (DIRECTORY ${GTK_SHARE_DIR} DESTINATION ./)

set (GTK_PIXBUFLOADERS_DIR "/usr/x86_64-w64-mingw32/sys-root/mingw/lib/gdk-pixbuf-2.0/2.10.0")
install (DIRECTORY ${GTK_PIXBUFLOADERS_DIR}
